...
let _langchain_core_retrievers_document_compressors = require("@langchain/core/retrievers/document_compressors");

//#region src/rerank.ts
/**
* Document compressor that uses `Cohere Rerank API`.
*/
var CohereRerank = class extends _langchain_core_retrievers_document_compressors.BaseDocumentCompressor {
	model;
	topN = 3;
	client;
	maxChunksPerDoc;
	constructor(fields) {
		super();
		this.client = require_client.getCohereClient(fields);
