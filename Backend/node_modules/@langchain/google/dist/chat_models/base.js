...
var BaseChatGoogle = class extends BaseChatModel {
	...
	constructor(params) {
		super(params);
		this.params = params;
		this._addVersion("@langchain/google", "0.1.10");
