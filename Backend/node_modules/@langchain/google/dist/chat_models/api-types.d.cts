//#region src/chat_models/api-types.d.ts
declare namespace Gemini {
  ...
  type GenerativeLanguageModality = "MODALITY_UNSPECIFIED" | "TEXT" | "IMAGE" | "VIDEO" | "AUDIO" | "DOCUMENT" | (string & {});
  ...
  namespace Tools {
    ...
    type Type = "TYPE_UNSPECIFIED" | "STRING" | "NUMBER" | "INTEGER" | "BOOLEAN" | "ARRAY" | "OBJECT" | "NULL" | (string & {});
    /**
  ...
  /** Grounding support. */
  interface GoogleAiGenerativelanguageV1betaGroundingSupport {
    /**
  ...
  interface GoogleAiGenerativelanguageV1betaSegment {
    /**
  ...
  type ModelStage = "MODEL_STAGE_UNSPECIFIED" | "UNSTABLE_EXPERIMENTAL" | "EXPERIMENTAL" | "PREVIEW" | "STABLE" | "LEGACY" | "DEPRECATED" | "RETIRED" | (string & {});
  /**
   ...
   * field.
   */
  interface FunctionResponseBlob {
    /** Raw bytes for media formats. */
    data?: string;
    /**
     * The IANA standard MIME type of the source data.
